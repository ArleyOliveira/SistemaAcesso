        ...
        <?php
            ...
            echo DivUtil::openDivRow();
                echo DivUtil::openDivColMod("col-md-5");
                    ...
                    echo form_input(array('id' => 'datanasc', 'name' => 'datanasc', 'class' => 'form-control datepicker', 'placeholder' => '', 'value' => (new DateTime($user->datanasc))->format('d/m/Y')), set_value('datanasc'));
                 echo DivUtil::closeDiv();
            echo DivUtil::closeDivRow();
            echo DivUtil::openDivRow();
                echo DivUtil::openDivColMod("col-md-10");
                    $sexo = ($user->sexo == "Feminino" ? 1 : 2);
                 ?>
                    ...
                    <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-1" style="padding-right: 50px">
                        <input type="radio" id="option-1" class="mdl-radio__button" name="sexo" value="Feminino" <?php if($sexo == 1) echo 'checked' ?> />
                        <span class="mdl-radio__label">Feminino</span>
                    </label>
                     <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="option-2">
                         <input type="radio" id="option-2" class="mdl-radio__button" name="sexo" value="masculino" <?php if($sexo == 2) echo 'checked' ?> />
